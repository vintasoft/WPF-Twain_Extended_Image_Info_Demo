...
3. Build the project ("WpfTwainExtendedImageInfoDemo.Net8.csproj" file) in Visual Studio or using .NET CLI:
   ```
   dotnet build WpfTwainExtendedImageInfoDemo.Net8.csproj
   ```
