...
3. Build the project ("WpfTwainExtendedImageInfoDemo.Net7.csproj" file) in Visual Studio or using .NET CLI:
   ```
   dotnet build WpfTwainExtendedImageInfoDemo.Net7.csproj
   ```
